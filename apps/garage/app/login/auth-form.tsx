  ...
  return (
    <Card className="mx-auto max-w-md overflow-hidden p-0">
      <div className="bg-[#ff5a1f] p-5 text-white">
        <p className="text-xs font-black uppercase tracking-wide text-orange-100">Owner access</p>
        <h2 className="mt-2 text-2xl font-black">Garage access</h2>
        <p className="mt-2 text-sm leading-6 text-orange-50">Track workforce, revenue, and active service jobs.</p>
      </div>
