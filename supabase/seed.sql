-- Replace these values after creating your first admin user in Supabase Auth.
-- Run this from the Supabase SQL editor once, then remove local copies that contain real identifiers.
--
-- update public.profiles
-- set role = 'super_admin', is_active = true
-- where email = 'founder@mechconnect.in';
